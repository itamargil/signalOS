...
|---|---|---|
| Web app | Next.js | Keep Next.js unless scale demands change |
| Database | Supabase / Postgres | Managed Postgres or dedicated infra |
| Landing pages | Next.js templates / Framer | Automated generation + deployment |
...
```json
{
  ...
  "hypothesis": "People learning handstands want fast feedback on form and progression.",
  "target_users": ["beginner calisthenics learners", "intermediate handstand learners"],
  "possible_signal_channels": ["TikTok", "Instagram", "Reddit", "landing page"],
  "initial_risks": ["hard to generate good video feedback", "fitness content is crowded"]
}
```
...
# Phase 5 — Learning System / Cross-Idea Intelligence

## Goal

The system improves as more ideas are tested.
...
After testing 20 ideas, the system should know:

```text
For fitness ideas, fear-based beginner mistake hooks outperform generic progress hooks.
For mind/self-development ideas, personal confession hooks generate comments but landing pages need concrete outcomes.
For ecommerce sample kits, landing page trust elements matter more than social virality.
```

## Phase 5 Success Criteria

New ideas benefit from previous experiments.

## Phase 5 Future Enhancements

- recommendation engine
- automated next-experiment generation
- portfolio-level dashboard
- cost-adjusted signal scoring
